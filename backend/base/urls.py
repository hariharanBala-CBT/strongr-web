...
urlpatterns = [
     ...
     path('organizationpage/',OrganizationBookingView.as_view(template_name='org_dashboard'), name='organization_page'),
     path('bookings/confirmed/', OrganizationBookingView.as_view(template_name='confirmed_bookings'), name='confirmed_bookings'),
     path('bookings/completed/', OrganizationBookingView.as_view(template_name='completed_bookings'), name='completed_bookings'),
     path('bookings/pending/', OrganizationBookingView.as_view(template_name='pending_bookings'), name='pending_bookings'),
     path('bookings/cancelled/', OrganizationBookingView.as_view(template_name='cancelled_bookings'), name='cancelled_bookings'),
     ...
     path('Happy-hours/location/', HappyhoursLocationListView.as_view(), name='happyhours_location' ),
     path('happyhours/manage/<int:pk>/', HappyHourPricingManageView.as_view(), name='manage_happyhours'),
     ...
     path('organization_location_list/rules' , OrganizationLocationRulesListView.as_view(), name='organization_location_list'),
     path('organization_location/<int:pk>/rules/', OrganizationLocationRulesView.as_view(), name='organization_location_rules'),
